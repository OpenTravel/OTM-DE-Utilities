...
/**
 * Orchestrator that performs on-demand validation of a collection of OTM libraries.
 */
public class ValidationOrchestrator {
    ...
    private TLModel loadModel() throws SchemaCompilerException {
        try {
            ...
            Project project = projectManager.newProject( File.createTempFile( "vld", ".otp" ),
                "http://www.opentravel.org", "OldVersions", null );
