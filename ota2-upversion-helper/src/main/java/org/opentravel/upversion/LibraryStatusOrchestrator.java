...
/**
 * Orchestrates the promotion and demotion of OTM libraries from one status to
 * another.
 */
public class LibraryStatusOrchestrator {
	...
	/**
	 * Assigns the list of repository items for all of the libraries to be promoted
	 * or demoted.
	 *
	...
	/**
	 * Assigns the status filter critera for libraries to be promoted or demoted.  Only
	 * libraries with the specified status will be affected by the 'updateStatus()' operation.
	 *
	...
	/**
	 * Assigns the action (promote or demote) that should be performed by the 'updateStatus()'
	 * operation.
	 * 
	...
	/**
	 * Returns the end-state status to which all affected libraries will be assigned after
	 * their statuses have been updated.  If the 'fromStatus' and 'statusAction' values are
	 * null or invalid, this method will return null.
	 * 
	...
	/**
	 * Returns the number of libraries from the original list that will
	 * be affected by the 'updateStatus()' operation.
	 * 
	 * @return int
	 */
	...
	/**
	 * Updates the status of all affected libraries based on the selection criteria
	 * specified by the caller.  If one or more libraries cannot be processed, this
	 * method will return false (true = all updates successful).
	 * 
	 * @return boolean
