...
/**
 * Wrapper for enumeration values that can provide user-displayable labels for the UI.
 */
public class EnumWrapper<T extends Enum<T>> {
    ...
    public boolean equals(Object other) {
        return (other instanceof EnumWrapper) && (this.enumValue == ((EnumWrapper<T>) other).enumValue);
    }
