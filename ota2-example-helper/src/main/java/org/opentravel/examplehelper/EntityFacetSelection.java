...
public class EntityFacetSelection {
	...
	/**
	 * Constructor that specifies the entity type and the available list of facet names
	 * for that type.
	 * 
	 * @param entityType  the qualified name of the OTM entity type
	 * @param facetList  the available facets for the entity (null for non-substitutable types)
	 */
