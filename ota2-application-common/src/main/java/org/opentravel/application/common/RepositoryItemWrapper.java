...
/**
 * Wrapper facade for the <code>RepositoryItem</code> interface that is extended to support equality checking and
...
public class RepositoryItemWrapper implements RepositoryItem, Comparable<RepositoryItemWrapper> {
    ...
    public boolean equals(Object obj) {
        return (obj instanceof RepositoryItemWrapper) && (compareTo( (RepositoryItemWrapper) obj ) == 0);
    }
