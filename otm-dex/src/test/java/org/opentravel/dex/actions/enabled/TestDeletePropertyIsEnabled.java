 ...
 */
public class TestDeletePropertyIsEnabled extends TestActionsIsEnabledBase {
    private static Logger log = LogManager.getLogger( TestDeletePropertyIsEnabled.class );

    /**
     */
    public TestDeletePropertyIsEnabled() {
        super( DexActions.DELETEPROPERTY );
    }
