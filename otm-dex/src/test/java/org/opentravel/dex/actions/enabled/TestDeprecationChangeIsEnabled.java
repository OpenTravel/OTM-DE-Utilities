...
public class TestDeprecationChangeIsEnabled extends TestActionsIsEnabledBase {
    private static Logger log = LogManager.getLogger( TestDeprecationChangeIsEnabled.class );

    /**
     */
    public TestDeprecationChangeIsEnabled() {
        super( DexActions.DEPRECATIONCHANGE );
    }
