...
import org.opentravel.dex.controllers.popup.TestNewLibraryDialogController;
...
import org.opentravel.model.TestOtmModelManager_Gets;
...
public class TestOtmVersionChain extends AbstractDexTest {
    ...
    /** ****************************** Old Tests ************************** **/
    /**
     * {@link OtmVersionChain#isLaterVersion(OtmLibrary, OtmLibrary)} method is static with two libraries as parameters
     */
