...
public class SetConstraintMaxExclusiveAction extends DexStringAction {
    ...
    private static final String VETO2 = "org.opentravel.schemacompiler.TLSimple.maxExclusive.MUST_BE_NULL_OR_BLANK";
    ...
    private static final String TESTSTRING = "MAXEzzzaaazzzaaaqwert";
    ...
    public static boolean isEnabled(OtmObject subject) {
        ...
        String savedValue = ((TLSimple) subject.getTL()).getMaxExclusive();
        ((OtmSimpleObject) subject).getTL().setMaxExclusive( TESTSTRING );
        boolean veto = ValidationUtils.isVetoed( VETOKEYS, subject );
        ((OtmSimpleObject) subject).getTL().setMaxExclusive( savedValue );
        subject.isValid( true ); // fix the findings

        return !veto;
    }

    public SetConstraintMaxExclusiveAction() {
    ...
    public String toString() {
        return "Set max exclusive to " + get();
    }
