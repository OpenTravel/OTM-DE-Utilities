...
/**
 * Abstract base class that provides a partial implementation for the <code>UndoableAction</code> interface.
 */
public abstract class UndoableAction {
    ...
    /**
     * Constructor that specifies the <code>UndoManager</code> that will execute this action.
     * 
    ...
    /**
     * Submits this action to the undo manager for execution and returns true if successful.
     * 
     * @return boolean
     */
    ...
    /**
     * Executes the action for the first time. This is typically done synchronously in response to a user's edit or
     * other action. This method should return true if the action is executed successfully, false otherwise.
     * 
     * @return boolean
     */
    ...
    /**
     * Performs all actions required to undo the original action (or a prior redo). It is the reponsibility of the
     * action implementor to ensure that the state of the application and any underlying data structures are returned to
     * the exact state that existed prior to the action's execution or a previous redo action.
     * 
     * <p>
     * This method should return true if the action is undone successfully, false otherwise.
     * 
     * @return boolean
     */
    ...
    /**
     * Performs all actions required to redo a previous undo action performed by this action. It is the reponsibility of
     * the action implementor to ensure that the state of the application and any underlying data structures are
     * returned to the exact state that existed after the original execution of this action.
     * 
     * <p>
     * This method should return true if the action is redone successfully, false otherwise.
     * 
     * @return boolean
     */
    ...
    /**
     * Returns system timestamp (as returned by <code>System.currentTimeMillis()</code>) when this action performed its
     * original execution or an undo/redo action.
     * 
     * @return long
     */
    ...
    /**
     * Returns true if this action can be merged with the next action that was executed immediately following this one.
     * Typically, this is used for consolidating text-edit events into a single action but may be useful in other
     * situations as well.
     * 
     * <p>
     * This method returns false by default. Sub-classes may override if merges are supported.
     * 
    ...
    /**
     * Merges the given action with this one. This method will only be called by the <code>UndoManager</code> if the
     * 'canMerge()' method returns true.
     * 
     * <p>
     * By default, this method always throws an <code>UnsupportedOperationException</code>. Sub-classes may override to
     * implement action-specific merge behaviour.
     * 
    ...
    /**
     * Assigns the delegate that will be executed during the initial execution of this action.
     *
