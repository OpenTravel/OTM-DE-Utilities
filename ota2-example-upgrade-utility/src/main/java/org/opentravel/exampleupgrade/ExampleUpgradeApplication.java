 ...
 */
public class ExampleUpgradeApplication extends AbstractOTMApplication {

    /**
     * Default constructor.
     */
    public ExampleUpgradeApplication() {}
     ...
     */
    public ExampleUpgradeApplication(RepositoryManager repositoryManager) {
    ...
    protected String getMainWindowTitle() {
        return "OTM-DE Example Upgrade Utility";
    }
