...
public class DiffUtilityApplicationProvider implements OTA2ApplicationProvider {
	...
	private static final OTA2ApplicationSpec spec = new OTA2ApplicationSpec(
			"Diff Utility", "Compares different versions or commits of OTM libraries, projects, or releases",
			20, OTA2LauncherTabSpec.RELEASED_TAB, Images.launcherIcon, OTMDiffApplication.class );
