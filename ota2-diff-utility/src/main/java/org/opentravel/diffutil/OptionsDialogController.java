...
/**
 * Controller used to select the option settings to be used when comparing OTM models, libraries, and entities.
 */
public class OptionsDialogController {
    ...
    @FXML
    private CheckBox suppressFieldVersionChangesCB;
    @FXML
    private CheckBox suppressLibraryPropertyChangesCB;
    @FXML
    private CheckBox suppressDocumentationChangesCB;
    ...
    /**
     * Assigns the <code>ModelCompareOptions</code> instance that will be updated by this dialog.
     *
