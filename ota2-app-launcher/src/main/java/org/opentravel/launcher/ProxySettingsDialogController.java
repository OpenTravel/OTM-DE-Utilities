...
public class ProxySettingsDialogController {
    ...
    private static final Pattern nphostPattern =
    ...
    @FXML
    private TextField nonProxyHostsText;
    @FXML
    ...
    public void selectOk(ActionEvent event) {
        ...
        settings.setProxyPort(
            StringUtils.isEmpty( proxyPortText.getText() ) ? null : Integer.parseInt( proxyPortText.getText() ) );
    ...
    /**
     * Called when the user updates the values in one of the visual controls to perform validation.
     */
    ...
    /**
     * If the given error message is null, the specified control will be assigned to a non-error visual status. If
     * non-null, an error highlighting will be applied and the tooltip set to the error message. This method returns
     * true if the control's content is valid; false if an error exists.
     * 
    ...
    /**
     * Checks the given hostname value and returns an error string or null if the hostname is valid.
     * 
    ...
    /**
     * Checks the given port number string value and returns an error string or null if the string is valid.
     * 
    ...
    /**
     * Checks the given non-proxy hosts string value and returns an error string or null if the string is valid.
     * 
